                ...
                <div class="row row-col-1 justify-content-center">
                    ...
                    <div class="form-group d-flex pl-2">
                        ...
                        <div class="form-group col address-holder">
                            ...
                            <textarea id="" cols="30" rows="3" required  name="delivery_address" class="form-control" style="resize:none"><?php echo $_settings->userdata('default_delivery_address') ?></textarea>
                        </div>
                        <div class="col">
